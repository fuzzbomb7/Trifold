...
namespace Trifold.Data.Migrations
{
    ...
    [Migration("20200205225827_BreweriesTable")]
    partial class BreweriesTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trifold.Models.BeerCsvRecords", b =>
                {
                    ...
                    b.Property<string>("UntappdBeer");

                    b.Property<string>("UntappdBrewery");
            ...
            modelBuilder.Entity("Trifold.Models.Breweries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("BreweryLogoUrl");

                    b.Property<string>("BreweryName");

                    b.Property<int?>("UntappdBreweryId");
            ...
            modelBuilder.Entity("Trifold.Models.CustomContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trifold.Models.Engagement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trifold.Models.Events", b =>
                {
                    ...
                    b.Property<string>("EventSecondaryColor");

                    b.Property<DateTime>("EventStartTime");

                    b.Property<string>("EventState");

                    b.Property<int>("EventTextContrast");
            ...
            modelBuilder.Entity("Trifold.Models.PromoLinks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PromoLinks");
                });

            modelBuilder.Entity("Trifold.Models.Ticketing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trifold.Models.Beers", b =>
                {
                    b.HasOne("Trifold.Models.Breweries", "Brewery")
                        .WithMany()
            ...
            modelBuilder.Entity("Trifold.Models.CustomContent", b =>
                {
                    b.HasOne("Trifold.Models.Events", "Event")
                        .WithOne("CustomContent")
                        .HasForeignKey("Trifold.Models.CustomContent", "EventId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Trifold.Models.Engagement", b =>
                {
                    b.HasOne("Trifold.Models.Events", "Event")
                        .WithOne("Engagement")
                        .HasForeignKey("Trifold.Models.Engagement", "EventId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Trifold.Models.Ticketing", b =>
                {
                    b.HasOne("Trifold.Models.Events", "Event")
                        .WithOne("Ticketing")
                        .HasForeignKey("Trifold.Models.Ticketing", "EventId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
